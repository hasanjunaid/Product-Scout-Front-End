...
import { LineChart, Line, XAxis, Brush, YAxis, CartesianGrid, Tooltip, Legend, ResponsiveContainer, BarChart, Bar, ComposedChart } from 'recharts';
      ...
      {loading ? <SplashScreen /> : (
        <div>
          ...
          <div className="navs">
            ...
            <div className="nav-cont">
              <div>
                ...
                <button className="trendz" onClick={() => { navigate("/hotcategoreis") }}>
                  Hot Products
                </button>
          ...
          <div className="graphs">
            <ResponsiveContainer className="chart2" width="45%" height="45%">
              <BarChart width={150} height={200} data={data2}>
                <CartesianGrid strokeDasharray="3 3" />
                <XAxis tick={xAxisTickStyle} dataKey="name" />
                <YAxis />
                <Bar dataKey="value" fill="#f2003d" />
                <text x={370} y={15} fontSize={20} textAnchor="middle" fill="#030637" >
                  Y-Axis: Trend Values, X-Axis: Relevant Categories
                </text>
                <Tooltip />
              </BarChart>
            </ResponsiveContainer>

            <ResponsiveContainer className="chart" width="45%" height="45%">
